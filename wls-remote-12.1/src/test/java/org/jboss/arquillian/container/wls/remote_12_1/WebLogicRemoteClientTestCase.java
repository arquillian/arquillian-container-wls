...
/**
 * Tests that WebLogic deployments into the WebLogic server work through the
 * Arquillian lifecycle. Extracted from the Tomcat testcases. 
 * 
...
public class WebLogicRemoteClientTestCase
{
   // -------------------------------------------------------------------------------------||
   // Class Members -----------------------------------------------------------------------||
   // -------------------------------------------------------------------------------------||
    ...
    * Logger
    */
   private static final Logger log = Logger.getLogger(WebLogicRemoteClientTestCase.class.getName());

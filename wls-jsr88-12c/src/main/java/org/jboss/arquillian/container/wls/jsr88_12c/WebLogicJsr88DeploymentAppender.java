...
/**
 * Package the required dependencies needed by the WebLogic Container plugin
 * to run in container.
 *
 * @author <a href="http://community.jboss.org/people/aslak">Aslak Knutsen</a>
 * @author <a href="http://community.jboss.org/people/LightGuard">Jason Porter</a>
 */
public class WebLogicJsr88DeploymentAppender implements AuxiliaryArchiveAppender
{
   ...
   {
      return ShrinkWrap.create(JavaArchive.class, "arquillian-weblogic-testenrichers.jar")
         .addPackages(
            true,

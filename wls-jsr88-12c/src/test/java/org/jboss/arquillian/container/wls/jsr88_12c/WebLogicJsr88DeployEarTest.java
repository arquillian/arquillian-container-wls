...
public class WebLogicJsr88DeployEarTest {
    /**
     * Logger
     */
    private static final Logger log = Logger.getLogger(WebLogicJsr88DeployEarTest.class.getName());
    ...
    public void shouldBeAbleToDeployEnterpriseArchive() throws Exception {
        ...
        final URLConnection response = new URL("http://localhost:7001/test" + servletPath).openConnection();
